...
db = SQLAlchemy(app) #esto es instancia de sqlalchemy en donde queda vinculada la base de datos con la aplicacion

class Organizador(db.Model): #aca decimos que cada clase es un modelo para la base de datos
